<template>
  <div class="hello">
    <h1 class="bg-gradient-to-b from-blue-100">{{ msg }}</h1>
    <p class="bg-gradient-to-t from-blue-200">
      For a guide and recipes on how to configure / customize this project,<br>
      check out the
      <a href="https://cli.vuejs.org" target="_blank" rel="noopener">vue-cli documentation</a>.
    </p>
    <h3 class="bg-gradient-to-b from-blue-100">Installed CLI Plugins</h3>
    <ul class="bg-gradient-to-t from-blue-200">
    ...
    <h3 class="bg-gradient-to-b from-blue-100">Essential Links</h3>
    <ul class="bg-gradient-to-t from-blue-200">
    ...
    <h3 class="bg-gradient-to-b from-blue-100">Ecosystem</h3>
    <ul class="bg-gradient-to-t from-blue-200">
